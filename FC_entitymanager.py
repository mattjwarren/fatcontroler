import FC_LOCAL,FC_TSM,FC_TELNET,FC_DUMB,FC_ENTITYGROUP,wx
import FC_formatter
###########
...
#
	...
	img=wx.Image('c:\\program files\\yab\\fatcontroller\\yellowalert.jpg', wx.BITMAP_TYPE_JPEG)
        self.AmberBMP=wx.BitmapFromImage(img)
	img=wx.Image('c:\\program files\\yab\\fatcontroller\\greenalert.jpg', wx.BITMAP_TYPE_JPEG)
